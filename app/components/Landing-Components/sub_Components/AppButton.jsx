...
const AppButton = ({src,app,small}) => {
  return (
    <button className="flex items-center gap-2 bg-black text-white rounded-full px-4 py-2 sm:px-7 sm:py-2.5 hover:bg-neutral-700 transition">
