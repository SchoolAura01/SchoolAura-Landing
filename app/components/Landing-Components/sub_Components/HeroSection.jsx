...
>
    ...
    <div className='hero-text flex flex-col items-center '>
        ...
        <h1 className="text-[clamp(1.3rem,5vw,2rem)] sm:text-[clamp(2rem,5vw,3.75rem)] font-semibold mt-4 leading-4 sm:leading-6">Smart <span className="italic font-normal font-['Instrument_Serif'] ">School ERP</span> That Connects </h1>
        <h1 className="text-[clamp(1.3rem,5vw,2rem)] sm:text-[clamp(2rem,5vw,3.75rem)] font-semibold">Schools, Parents, And Students</h1>
        <p className="w-[80%] mx-auto font-['Instrument_Serif'] font-light tracking-tight text-xs   sm:text-[clamp(0.5rem,6vw,1.2rem)] text-center leading-4 sm:leading-6">SchoolAura brings attendance, fees, homework, grades, and announcements into one friendly platform — with dedicated apps for parents and students.</p>
    </div>
...
<p className='text-gray-700 text-[10px] sm:text-sm leading-4 mt-1 md:mt-2'>Trusted and Downloaded by thousands of peoples around the world.</p>
      ...
      <div className='flex gap-3 mt-4 md:mt-8 mx-auto justify-center w-full'>
