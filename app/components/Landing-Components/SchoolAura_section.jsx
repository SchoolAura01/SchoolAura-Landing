...
// 
  return (
    <section>
      <div
        className="schoolAuraSection container relative mx-auto my-0 bg-white grid 
      grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4  w-[96%]  md:w-[90%]  py-10"
      >
        <div className="bg-linear-to-r from-[#252ffd] to-[#06e3ff] rounded-2xl sm:rounded-3xl col-span-3 lg:col-span-2 software-card-1 flex items-end md:gap-7">
          <div className="left flex justify-end flex-col text-white w-[65%] sm:w-[55%] p-5 md:p-8">
    ...
    />
        ...
        <div className="right flex justify-end flex-col text-black p-5 md:p-8">
        ...
        <div className="left flex justify-end flex-col text-black p-5 md:p-8">
    ...
    />
        ...
        <div className="left flex justify-end flex-col text-black w-[65%] lg:w-[45%] p-5 md:p-8">
          ...
          <div className="relative img rotate-15 translate-y-2 md:translate-y-10 mx-auto">
    <Image
